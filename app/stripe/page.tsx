  ...
  return (
    <div className="container">
      ...
      <div className="content">
        ...
        {!connectedAccountId && <p>Environnement de test par défaut is the world's leading air travel platform: join our team of pilots to help people travel faster.</p>}
